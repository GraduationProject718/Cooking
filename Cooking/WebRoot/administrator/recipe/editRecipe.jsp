   	...
   	<form class="layui-form" action="RecipeServlet?method=editRecipe" method="post" enctype="multipart/form-data">
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input value="${recipe.r_name}" style="width:300px;" type="text" name="r_name"  id="r_name" class="layui-input" autocomplete="off" required  lay-verify="required" placeholder="请输入菜名"/>
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label"><b>简介</b></label>
		    <div class="layui-input-inline">
		    	<textarea style="width:500px;" placeholder="请输入内容" class="layui-textarea" name="r_information"  id="r_information">${recipe.r_information}</textarea><br />
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label"><b>材料</b></label>
		    <div class="layui-input-inline">
		    	<textarea style="width:500px;" placeholder="请输入内容" class="layui-textarea" name="r_material" id="r_material">${recipe.r_material}</textarea><br />
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label"><b>做法</b></label>
		    <div class="layui-input-inline">
		    	<textarea style="width:500px;" placeholder="请输入内容" class="layui-textarea" name="r_practice"  id="r_practice">${recipe.r_practice}</textarea><br />
		    </div>
		  </div>
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		    	...
		    	<img style="width:50px;height:50px;" src="${pageContext.request.contextPath}/${recipe.r_img}">
		    </div>
		  </div>
		   <div class="layui-form-item">
		    ...
		    <div class="layui-input-block" style="width:400px;">
		      <select name="r_RBDId">
		     	 <c:forEach items="${rbd}" var="r">
		     	 	<c:if test="${r.rbd_id == recipe.r_RBDId }">
		       			<option value="${r.rbd_id}" selected="selected" >${r.rbd_name}</option>
		       		</c:if>
